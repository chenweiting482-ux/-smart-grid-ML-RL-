...
from rl_environment import BatteryStorageEnv, EPISODE_HOURS
...
def quick_eval(model_path="saved_models/ppo_battery"):
    ...
    from rl_environment import (BatteryStorageEnv, SEQ_LEN, EPISODE_HOURS,
    ...
    def rule_action(o):
        ...
        if   p >= 0.40: return 0   # peak → discharge
        elif p <= 0.10: return 2   # off-peak → charge
        elif s > 1.0:   return 2   # solar → charge
        else:           return 1
